...
# 模型路径
config_path = '/data/PretrainedModels/NEZHA-Base-WWM/bert_config.json'
checkpoint_path = '/data/PretrainedModels/NEZHA-Base-WWM/model.ckpt-691689'
dict_path = '/data/PretrainedModels/NEZHA-Base-WWM/vocab.txt'
